...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">INFORMACION SOBRE ROEDORES</h1>
                <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <img class="img-responsive" src="images/r2.jpg" alt="">
                        </div>
                        <div class="item">
            ...
            <div class="col-md-4">
              <!--   <h3>Project Description</h3> -->
                <p >Constituyen el ordenen de mamíferos con más cantidad de especies, existen casi 2300 especies en el mundo, solo 3 de estos son considerados plagas:</p>
<br>
    <p>Ratón doméstico</p>

    <p>Rata de los tejados</p>

    <p>Rata noruega o de alcantarilla</p>
    <br>
...
<p>
Su capacidad de adaptación al entorno es sorprendente, ya que pueden consumir alimentos en buen estado y en mal estado, expertos le atribuyen la amplia facilidad de reproducción por su nivel de fecundidad y su capacidad de escabullirse y esconderse de los depredadores.</p>

<p>Las enfermedades y los daños económicos que estos generan lo hace una de las plagas más importantes dentro del Programa de Control de Plagas.</p>
