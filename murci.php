...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
 ...
 <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">INFORMACION SOBRE MURCIELAGOS</h1>
                <ol class="breadcrumb">
                    <li><a href="index.php" style="color: black">Inicio</a>
                    </li>
                    <li class="active">Plagas Item</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-4">
               <!--  <h3 style="color: black">Project Description</h3> -->
                <p>Los quirópteros (Chiroptera), conocidos comúnmente como murciélagos, son un orden de mamíferos placentarios cuyas extremidades superiores se desarrollaron como alas. Con aproximadamente 1100 especies, representan aproximadamente un 20% de todas las especies de mamíferos, lo que los convierte en el segundo orden más numeroso de esta clase (tras los roedores). Están presentes en todos los continentes, excepto en la Antártida.</p>

                <p>De lo que muchas personas no se dan cuenta es que el murciélago juega un papel importante en muchos ecosistemas, ayudan a mantener las poblaciones de insectos y bichos controladas. También ayudan con la polinización, algo de lo que las abejas y los pájaros se llevan generalmente todo el mérito.</p>



                <p>Si bien el formato básico de todos los murciélagos es similar, puede que te sorprenda descubrir que existen más de 1.100 especies identificadas. Aproximadamente el 70% se alimentan de insectos y el resto consume fruta. El tamaño del murciélago varía significativamente en función de la ubicación y especie. Algunos no pesan ni siquiera una onza y superando los pocos centímetros, otros son considerablemente más grandes, con una longitud de cerca de cinco pies, pesando unas tres libras.</p>
